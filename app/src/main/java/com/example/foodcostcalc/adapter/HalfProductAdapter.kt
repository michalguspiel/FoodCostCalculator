...
class HalfProductAdapter(private val list: ArrayList<HalfProductWithProductsIncluded>,
    ...
    class RecyclerViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val unitOfHalfProduct: TextView = view.findViewById(R.id.unit_to_populate_half_product_card_view)
        val finalPriceOfHalfProductPerUnit: TextView = view.findViewById(R.id.price_of_half_product_per_unit)

    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerViewHolder {
        val adapterLayout = LayoutInflater.from(parent.context).inflate(R.layout.half_product_card_view, parent, false)
        return HalfProductAdapter.RecyclerViewHolder(adapterLayout)
    }
