...
class ProductsFragmentRecyclerAdapter(
    ...
    private var itemsSizeWithAds = adCase.finalListSize
    ...
    private fun refreshAdCase() {
        ...
        itemsSizeWithAds = adCase.finalListSize
    ...
    inner class RecyclerViewHolder(private val viewBinding: ListProductBinding) :
        ...
        fun bind() {
            ...
            viewBinding.productNettoPrice.text =
                "Price ${list[positionIncludedAdsBinded].unit} netto: ${
                    formatPrice(
                        list[positionIncludedAdsBinded].pricePerUnit,
                        activity
                    )
                }."
            viewBinding.productFoodcostPrice.text =
                "Price ${list[positionIncludedAdsBinded].unit} with foodcost: ${
                    formatPrice(
                        list[positionIncludedAdsBinded].priceAfterWasteAndTax,
                        activity
                    )
                }."
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        return if (positionsOfAds.contains(position)) PRODUCT_AD_ITEM_TYPE
