...
class RecyclerViewAdapter(val tag: String?, private val list: ArrayList<Product>, private val fragmentManager: FragmentManager,val viewModel: RecyclerViewAdapterViewModel)
    ...
    private val PRODUCT_ITEM_TYPE = 1
     ...
     inner class RecyclerViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(position: Int){
            ...
            nettoTextView.text = "Price ${list[position].unit} netto: ${formatPrice(list[position].pricePerUnit)}."
            foodcostTextView.text = "Price ${list[position].unit} with foodcost: ${formatPrice(list[position].priceAfterWasteAndTax)}."
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        when (viewType) {
            PRODUCT_ITEM_TYPE -> {
                ...
                val adapterLayout =
                    LayoutInflater.from(parent.context).inflate(R.layout.products_recycler_last_item,parent,false)
